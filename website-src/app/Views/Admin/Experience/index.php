...
<!-- Seccion Titulo -->
<?= $this->section('header') ?>
<i class="nav-icon fas fa-industry"></i> Gestión de Experiencia
<?= $this->endSection() ?>
<!-- Seccion Contenido -->
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <table id="tableExperience" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>#</th>
                  <th>Empresa</th>
...
<script>
    tableExperience = $('#tableExperience').DataTable({
        language: {
        ...
        buttons: [{
                ...
                action: function(e, dt, button, config) {
                    $(location).attr('href', '<?=site_url(route_to('create_experience')) ?>');
                },
                className: 'btn btn-danger',
                text: '<i class="nav-icon fas fa-industry"> +</i>'
            },
            {
                //Botón para CSV
                extend: 'csvHtml5',
        ...
        responsive: true,
        ajax: {
            url: '<?= site_url(route_to('datatable_experience')); ?>',
    ...
    //Captura los cambios del select y recarga la tabla
      $('#tableExperience').change(function(event) {
