...
<!-- Seccion Titulo -->
<?= $this->section('header') ?>
<i class="nav-icon fas fa-industry"></i> Alta
<?= $this->endSection() ?>
<!-- Seccion Contenido -->
            ...
            <div class="col-md-4">
                ...
                <div class="card card-danger card-outline">
                    <div class="card-body box-profile">
                        <h3 class="profile-username text-center" ><span id="company-preview"><?= old('company') ?? '***'?></span></h3>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="settings">
                                <form enctype="multipart/form-data" action="<?= site_url(route_to('store_experience'))?>" method="post" class="form-horizontal" name="formExperience">
                                    <?= csrf_field() ?>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group">
                                                ...
                                                <input required type="text" name="company" class="form-control <?= session('errors.company') ? 'is-invalid' : '' ?>" value="<?= old('company') ?>" placeholder="Empresa / Institucion" autocomplete="off">
