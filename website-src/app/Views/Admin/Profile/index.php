...
<!-- Seccion Titulo -->
<?= $this->section('header') ?>
<i class="nav-icon fab fa-teamspeak"></i> Gestión de Perfiles
<?= $this->endSection() ?>
<!-- Seccion Contenido -->
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <table id="tableProfile" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>#</th>
                  <th>Nombre</th>
...
<script>
    tableProfile = $('#tableProfile').DataTable({
        language: {
        ...
        buttons: [{
                ...
                action: function(e, dt, button, config) {
                    $(location).attr('href', '<?=site_url(route_to('create_profile')) ?>');
                },
                className: 'btn btn-success',
                text: '<i class="nav-icon fab fa-teamspeak"> +</i>'
            },
            {
                //Botón para CSV
                extend: 'csvHtml5',
        ...
        responsive: true,
        ajax: {
            url: '<?= site_url(route_to('datatable_profile')); ?>',
    ...
    //Captura los cambios del select y recarga la tabla
      $('#tableProfile').change(function(event) {
        tableProfile.ajax.reload();
    });
</script>
<?= $this->endSection() ?>